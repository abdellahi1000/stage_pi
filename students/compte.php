    ...
    <div class="flex">
        ...
        <main class="flex-1 min-h-screen overflow-y-auto md:ml-64">
            ...
            <div class="max-w-5xl mx-auto px-6 py-10">
                <h1 class="text-4xl font-extrabold text-gray-900 mb-2">Mon Compte</h1>
                <p class="text-gray-600 mb-8">Gérez votre profil, vos candidatures et vos informations personnelles.</p>

                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div class="lg:col-span-1">
                        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center">
                            <div class="relative w-32 h-32 mx-auto mb-4">
                                <img id="profil-img" class="w-full h-full rounded-full object-cover border-4 border-blue-50" src="https://ui-avatars.com/api/?name=<?php echo urlencode(($_SESSION['user_prenom'] ?? '') . ' ' . ($_SESSION['user_nom'] ?? '')); ?>&background=random" alt="Photo de profil">
                            ...
                            <h2 class="font-bold text-xl text-gray-800"><?php echo htmlspecialchars(($_SESSION['user_prenom'] ?? '') . ' ' . ($_SESSION['user_nom'] ?? '')); ?></h2>
                            ...
                            <form class="space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="px-4 py-3 bg-gray-50 rounded-lg border border-gray-100 text-gray-600"><?php echo htmlspecialchars($_SESSION['user_prenom'] ?? '...'); ?></p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
