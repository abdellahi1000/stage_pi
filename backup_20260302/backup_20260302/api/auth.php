    ...
    try {
        ...
        if ($user['type_compte'] === 'entreprise') {
            if ($user['account_status'] === 'pending') {
                echo json_encode(['success' => false, 'message' => 'Veuillez vérifier votre email avant de pouvoir vous connecter.']);
                exit;
            } else if ($user['account_status'] === 'email_verified') {
                echo json_encode(['success' => false, 'message' => 'Votre compte est en cours de validation par un administrateur.']);
                exit;
            } else if ($user['account_status'] === 'rejected') {
                echo json_encode(['success' => false, 'message' => 'Votre inscription a été rejetée.']);
                exit;
            }
        }
        */
