...
elseif ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $db->prepare("INSERT INTO offres (user_id, titre, entreprise, description, localisation, type_contrat, nombre_stagiaires, duree, remuneration, statut, categorie_id) VALUES (:user_id, :titre, :entreprise, :description, :localisation, :type_contrat, :nombre_stagiaires, :duree, :remuneration, :statut, :categorie_id)");
...
elseif ($_SERVER['REQUEST_METHOD'] === 'PUT') {
    ...
    try {
        ...
        $allowed = ['titre', 'description', 'localisation', 'type_contrat', 'nombre_stagiaires', 'duree', 'remuneration', 'statut', 'categorie_id'];
        ...
        $sql = "UPDATE offres SET " . implode(', ', $fields) . " WHERE id = :id AND user_id = :user_id";
        $stmt = $db->prepare($sql);
        $stmt->execute($params);
...
elseif ($_SERVER['REQUEST_METHOD'] === 'DELETE') {
    ...
    try {
        $stmt = $db->prepare("DELETE FROM offres WHERE id = :id AND user_id = :user_id");
