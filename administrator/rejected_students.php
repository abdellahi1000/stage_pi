...
<head>
    ...
    <title>Candidats Refusés - StageMatch</title>
    <!-- CSS -->
    ...
    <div class="flex">
        ...
        <main class="flex-1 min-h-screen overflow-y-auto bg-gray-50 md:ml-64">
            ...
            <div class="max-w-5xl mx-auto px-6 py-10">
                <div class="mb-10">
                    <h1 class="text-4xl font-extrabold text-gray-900 mb-1">Candidats Refusés</h1>
                    <p class="text-gray-500 font-medium">Consultez l'historique des candidatures refusées.</p>
                </div>
